...
export const metricCardsData = (
  ...
  return [
    ...
    },
    {
      ...
      description: t('metrics.totalInvoiced'),
      icon: DollarSign,
      ...
      badgeText: t('metrics.totalInvoiced'),
    ...
    },
    {
      ...
      description: t('metrics.outstandingAmount'),
      icon: AlertTriangle,
